...
import { Text, Heading, BaseLayout, Button, LinkExternal, Flex, Image } from '@bscindex/uikit'
    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <List>
            <li>{TranslateString(596, 'Buy CID and BNB tokens')}</li>
          ...
          <List>
            <li>{TranslateString(602, 'While the sale is live, commit your CID-LP tokens to buy the IFO tokens')}</li>
          </List>
