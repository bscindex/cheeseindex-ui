...
import { Heading, Text, Flex, ChevronRightIcon } from '@bscindex/uikit'
  ...
  return (
    <>
      <Heading as="h4" size="md" mb="8px">
        {TranslateString(999, 'CheeseIndexToken Collectibles')}
      </Heading>
      <Text as="p">
        {TranslateString(
          999,
          'CheeseIndexToken Collectibles are special ERC-721 NFTs that can be used on the CheeseIndexTokenSwap platform.',
        )}
      </Text>
      <Text as="p">
        {TranslateString(
          999,
          "NFTs in this user's wallet that aren't approved CheeseIndexToken Collectibles won't be shown here.",
        )}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="flex-end">
        <Link to="/collectibles">{TranslateString(999, 'See all approved CheeseIndexToken Collectibles')}</Link>
        <ChevronRightIcon />
      </Flex>
    </>
  )
