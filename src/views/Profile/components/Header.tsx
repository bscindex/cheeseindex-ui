...
import { Button, Flex, Heading, useModal, Won } from '@bscindex/uikit'
import { useProfile } from 'state/hooks'
import useI18n from 'hooks/useI18n'
import ClaimNftAndCidModal, { useCanClaim } from './ClaimGiftModal'
...
const ProfileHeader = () => {
  ...
  const [onPresentClaimGiftModal] = useModal(<ClaimNftAndCidModal onSuccess={checkClaimStatus} />)
