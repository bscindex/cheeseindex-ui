...
import { Heading, CardBody, CardFooter, BSCIndexRoundIcon, TicketRound } from '@bscindex/uikit'
      ...
      <>
        <CardBody>
          <CardHeading>
            ...
            <LotteryCardHeading
              valueToDisplay={TranslateString(999, `${poolSize.toLocaleString()} CID`)}
              Icon={BSCIndexRoundIcon}
            >
