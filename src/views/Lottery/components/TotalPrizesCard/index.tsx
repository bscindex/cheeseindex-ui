...
import { Heading, Card, CardBody, CardFooter, Text, BSCIndexRoundIcon, Flex, Skeleton } from '@bscindex/uikit'
        ...
        <CardHeading>
          <Left>
            ...
            <PrizeCountWrapper>
              ...
              <Heading size="lg">{lotteryPrizeWithCommaSeparators} CID</Heading>
            </PrizeCountWrapper>
          </Left>
          <Right>
